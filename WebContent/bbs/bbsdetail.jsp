...
<tr height="500px">
   <td  align="left"  style="padding: 10px 10px 10px 10px;"><img src="http://192.168.0.111/a_GoBack_JJIN/upload/<%=bbs.getNewfilename() %>" width="50%"><br><br><%=dto.getContent() %></td>
</tr>
<% }else{ %>
...
function updateBbs( seq ) {   
   location.href = "<%=request.getContextPath() %>/index.jsp?toss=bbs/bbsupdate&seq=<%=seq %>" 
}
function deleteBbs( seq ) {
   location.href = "<%=request.getContextPath() %>/index.jsp?toss=bbs/bbsdelete&seq=<%=seq %>" 
}
</script>
...
function getCommentsList() {
    $.ajax({
          ...
          success:function(str){
             ...
             if(str.trim() == "[]"){
                 data += "<tr>";             
                 data += "<th colspan='5' style='font-size: 15px;'>";
