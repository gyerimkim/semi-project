...
<div class="card-header" style="background-color: white; padding-bottom: 0;">
   ...
   <div align="right">
 <br><br><br><button type="button" class="button" onclick=location.href="<%=request.getContextPath() %>/index.jsp?toss=bbs/bbswrite">글쓰기</button>
      ...
      <tr>
         ...
         <td>
            ...
            if(bbs.getDel() == 0){
               ...
               <a href = "<%=request.getContextPath() %>/index.jsp?toss=bbs/bbsdetail&seq=<%=bbs.getSeq()%>"><%=bbs.getTitle() %> </a>
               <%}else{ %>
               
               <a href = "<%=request.getContextPath() %>/index.jsp?toss=bbs/bbsdetail&seq=<%=bbs.getSeq()%>"><%=bbs.getTitle() %> <font color = "gray">[<%=count = comDao.commentsCount(bbs.getSeq()) %>]</font></a>                          
               <% }     /////////// 댓글수 불러오기/////////////// 끝
...
if( n == 1) { //키워드로 검색 시
   ...
   location.href = "<%=request.getContextPath() %>/index.jsp?toss=bbs/bbslist&choice=" + choice + "&search=" + search;
  ...
  // alert(cagoselect.trim());
   ...
   location.href = "<%=request.getContextPath() %>/index.jsp?toss=bbs/bbslist&choice=" + choice + "&cagoselect=" + cagoselect; 
}
...
function goPage( pageNum ) {
   ...
   location.href =  "<%=request.getContextPath() %>/index.jsp?toss=bbs/bbslist&choice="  + choice + "&search=" + search + "&pageNumber=" + pageNum;
}
